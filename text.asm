...
_YourNameIsText::
	text "Понятно! Так тебе"  ; I see! So your
	line "зовут <PLAYER>!"    ; name is <PLAYER>!
	prompt

_HisNameIsText::
	text "Это верно! Я"       ; That's right! I
	line "вспомнил! Его"      ; remember now! His
	cont "зовут <RIVAL>!"     ; name is <RIVAL>!
	prompt
